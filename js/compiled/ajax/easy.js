...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__5901 = cljs.core.second(format);
var G__5902 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__5901,G__5902) : ajax.easy.keyword_response_format_element.call(null,G__5901,G__5902));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__5905_SHARP_){
return ajax.easy.keyword_response_format_element(p1__5905_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__5906){
var map__5907 = p__5906;
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5907__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5907__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5907__$1,cljs.core.cst$kw$finally);
...
return ((function (h,e,map__5907,map__5907__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__5909){
var vec__5910 = p__5909;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5910,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5910,(1),null);
var fexpr__5913_5914 = (cljs.core.truth_(ok)?h:e);
(fexpr__5913_5914.cljs$core$IFn$_invoke$arity$1 ? fexpr__5913_5914.cljs$core$IFn$_invoke$arity$1(result) : fexpr__5913_5914.call(null,result));
...
;})(h,e,map__5907,map__5907__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__5915){
...
var opts = map__5916__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5916__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5916__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5916__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5916__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5916__$1,cljs.core.cst$kw$body);
