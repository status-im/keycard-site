...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__5887){
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5888__$1,cljs.core.cst$kw$handler);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__4131__auto__ = p1__5890_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__5891){
var map__5892 = p__5891;
var map__5892__$1 = (((((!((map__5892 == null))))?(((((map__5892.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__5892.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__5892):map__5892);
var request = map__5892__$1;
var interceptors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5892__$1,cljs.core.cst$kw$interceptors);
