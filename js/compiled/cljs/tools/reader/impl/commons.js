...
var G__7443 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__7443;
continue;
} else {
return ch;
...
var vec__7444 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7444,(0),null);
return (match === s);
});
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq7447){
...
return (function() { 
var G__7452__delegate = function (rdr,_){
...
var G__7452 = function (rdr,var_args){
var _ = null;
